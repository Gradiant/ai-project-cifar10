...
def random_split_segmentation(
    ...
    Args:
        annotations_file:
            File in COCO [segmentation](https://gradiant.github.io/ai-dataset-template/supported_tasks/#segmentation) format.
        output_matched_file:
...
if __name__ == "__main__":
    fire.Fire(random_split_segmentation)
